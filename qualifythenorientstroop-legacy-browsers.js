...
function ConfigRoutineBegin(snapshot) {
  return async function () {
    ...
    ConfigComponents.forEach( function(thisComponent) {
...
function GeneralIntroductionRoutineBegin(snapshot) {
  return async function () {
    ...
    GeneralIntroductionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function consent_mainRoutineBegin(snapshot) {
  return async function () {
    ...
    consent_mainComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function consent_endRoutineBegin(snapshot) {
  return async function () {
    ...
    consent_endComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function demographics_mainRoutineBegin(snapshot) {
  return async function () {
    ...
    demographics_mainComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function demographics_endRoutineBegin(snapshot) {
  return async function () {
    ...
    demographics_endComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function attitudes_mainRoutineBegin(snapshot) {
  return async function () {
    ...
    attitudes_mainComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function attutides_endRoutineBegin(snapshot) {
  return async function () {
    ...
    attutides_endComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function orientation_trialLoopBegin(orientation_trialLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    orientation_trial.forEach(function() {
...
function gender_stroop_trialLoopBegin(gender_stroop_trialLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    gender_stroop_trial.forEach(function() {
...
function QualifyIntroRoutineBegin(snapshot) {
  return async function () {
    ...
    QualifyIntroComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function QualifyTaskRoutineBegin(snapshot) {
  return async function () {
    ...
    QualifyTaskComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function DidTheyQualifyFortheExperimentRoutineBegin(snapshot) {
  return async function () {
    ...
    DidTheyQualifyFortheExperimentComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function DisQualifyRoutineBegin(snapshot) {
  return async function () {
    ...
    DisQualifyComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function counterbalancing_routineRoutineBegin(snapshot) {
  return async function () {
    ...
    counterbalancing_routineComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function orientation_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    orientation_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function orientation_stroop_routineRoutineBegin(snapshot) {
  return async function () {
    ...
    orientation_stroop_routineComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function gender_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    gender_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function gender_stroop_routineRoutineBegin(snapshot) {
  return async function () {
    ...
    gender_stroop_routineComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function consent_end_2RoutineBegin(snapshot) {
  return async function () {
    ...
    consent_end_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
